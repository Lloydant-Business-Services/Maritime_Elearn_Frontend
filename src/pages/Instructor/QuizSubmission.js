...
class InstructorQuizSubmission extends Component {
	state = {
		pageLoading: false,
		thisSubmission: [],
	...
	loadDataFromServer = () => {
		...
		Endpoint.getQuizSubmissionById(this.props.location.state.data.quizSubmissionId)
			.then((res) => {
				console.log(res.data);
						...
						<h1 className="mb-0 text-primary">
							<Unicons.UilPen size="24" className="mr-1"/>
							{
								this.state.thisSubmission && this.state.thisSubmission.studentName ?
									...
									: null
							} | <span className="h2"> Student quiz submission</span>
						</h1>
							...
							<div className="row">
								<div className="col-md-12 my-3">
									...
									<textarea cols="30" rows="3" className="form-control"
											  ...
											  value={this.state.thisSubmission.quizInTextSubmission} readOnly>
									</textarea>
								</div>
								
								{
									this.state.thisSubmission && this.state.thisSubmission.quizSubmissionHostedLink ?
...
export default InstructorQuizSubmission
